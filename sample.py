...
for epoch in range(current_epoch-1,num_epochs):
    ...
    with torch.no_grad():  
        ...
        print("GTS Val Example:", list(gts_val.items())[:20])
        print("Res Val Example:", list(res_val.items())[:20])
    ...
    with torch.no_grad():
        ...
        print("GTS Test Example:", list(gts_test.items())[:20])
        print("Res Test Example:", list(res_test.items())[:20])
