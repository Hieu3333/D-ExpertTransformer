...
from dataloader import IUXrayDataLoader
...
train_dataloader = IUXrayDataLoader(args, tokenizer, split='train',shuffle=True)
val_dataloader = IUXrayDataLoader(args,tokenizer,split='val',shuffle=False)
test_dataloader = IUXrayDataLoader(args,tokenizer,split='test',shuffle=False)
